    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
  "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-auto shrink-0",
  className
)}
          {...props}
        >
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2 text-left text-sm transition hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/30 data-[active=true]:bg-white/15 data-[active=true]:border-white/20",
  {
    variants: {
      variant: {
