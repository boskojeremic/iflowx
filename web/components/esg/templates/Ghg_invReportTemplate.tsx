import { GhgInvReportMeta } from "@/lib/ghg_inv-report-meta";
import { Ghg_InvPreviewData } from "@/lib/esg/get-ghg_inv-report-data";

type Props = {
  report: GhgInvReportMeta;
  reportDate: string;
  data: Ghg_InvPreviewData;
};
